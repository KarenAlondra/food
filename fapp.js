...
document.getElementById("recipes").innerHTML = userDetail.map(user =>
  `<div>
  <h1 style="color: rgb(99,10,16);">${user.title}</h1>
    <h3 style="color: rgb(145,31,39);">Time:${user.time}</h3>
    <h3 style="color: rgb(145,31,39);">Calories: ${user.calories}</h3>
   <h3 style="color: rgb(145,31,39);"> Ingredients: ${user.ingredients}</h3>
    </div>`
).join('')
